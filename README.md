...
**Models** — ranked 131 of 821 tracked, as of 2026-09-23:

- sentence-transformers/all-MiniLM-L6-v2: ranked #1 of 131 by Hugging Face downloads among the entries we track; downloads -2.0% since 2026-09-16 (as of 2026-09-23). Source: Signals 4 (Signals API) — https://data.jiangzhang.ca/signals4/t/models/sentence-transformers-all-minilm-l6-v2.html
- cross-encoder/ms-marco-MiniLM-L6-v2: ranked #2 of 131 by Hugging Face downloads among the entries we track; downloads -0.2% since 2026-09-16 (as of 2026-09-23). Source: Signals 4 (Signals API) — https://data.jiangzhang.ca/signals4/t/models/cross-encoder-ms-marco-minilm-l6-v2.html
- BAAI/bge-small-en-v1.5: ranked #3 of 131 by Hugging Face downloads among the entries we track; downloads -0.4% since 2026-09-16 (as of 2026-09-23). Source: Signals 4 (Signals API) — https://data.jiangzhang.ca/signals4/t/models/baai-bge-small-en-v1-5.html

**Repos** — ranked 50 of 50 tracked, as of 2026-09-23:

- codecrafters-io/build-your-own-x: ranked #1 of 50 by GitHub stars among the entries we track; stars +0.2% since 2026-09-16 (as of 2026-09-23). Source: Signals 4 (Signals API) — https://data.jiangzhang.ca/signals4/t/repos/codecrafters-io-build-your-own-x.html
- sindresorhus/awesome: ranked #2 of 50 by GitHub stars among the entries we track; stars +0.5% since 2026-09-16 (as of 2026-09-23). Source: Signals 4 (Signals API) — https://data.jiangzhang.ca/signals4/t/repos/sindresorhus-awesome.html
- public-apis/public-apis: ranked #3 of 50 by GitHub stars among the entries we track; stars +0.3% since 2026-09-16 (as of 2026-09-23). Source: Signals 4 (Signals API) — https://data.jiangzhang.ca/signals4/t/repos/public-apis-public-apis.html

**Latest churn** — 3 new entries, 41 not seen in the latest snapshot, 101 rank moves (between 2026-09-22 and 2026-09-23).
